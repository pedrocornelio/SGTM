...
public class NovasAplicacoesAlmox extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NovasAplicacoesAlmox frame = new NovasAplicacoesAlmox();
	...
	public NovasAplicacoesAlmox() {
		...
		label_4.setBounds(302, 85, 22, 14);
		...
		textFieldPlaca.setBounds(355, 81, 98, 23);
		...
		scrollPane.setBounds(21, 160, 409, 132);
		...
		tableAplicacao.setModel(aplicacaoDao.tableAplicacao(modelAplicacao, Entrada.produtoAplicacao.getId_produto()));
