...
public class HistoricoSaida extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HistoricoSaida frame = new HistoricoSaida();
	...
	public HistoricoSaida() throws ParseException {
		...
		JLabel lblTitulo = new JLabel("HIST\u00D3RICO DE SA\u00CDDA");
		...
		tablePesquisa.setFont(new Font("Arial", Font.PLAIN, 12));
		TableFilterHeader filterHeader = new TableFilterHeader(tablePesquisa, AutoChoices.ENABLED);
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				DefaultTableModel modelPesquisa = new DefaultTableModel();
				tablePesquisa.setModel(historicoProdutoSaidaDao.tableHistoricoSaidaPesquisa(modelPesquisa, dataInicio, dataFim));
				tablePesquisa.getColumnModel().getColumn(0).setMinWidth(30);
				tablePesquisa.getColumnModel().getColumn(0).setPreferredWidth(35);
				tablePesquisa.getColumnModel().getColumn(0).setMaxWidth(45);
				tablePesquisa.getColumnModel().getColumn(1).setMinWidth(68);
				tablePesquisa.getColumnModel().getColumn(1).setPreferredWidth(70);
				tablePesquisa.getColumnModel().getColumn(1).setMaxWidth(72);
				tablePesquisa.getColumnModel().getColumn(3).setMinWidth(60);
				tablePesquisa.getColumnModel().getColumn(3).setPreferredWidth(60);
				tablePesquisa.getColumnModel().getColumn(3).setMaxWidth(65);
				tablePesquisa.getColumnModel().getColumn(5).setMinWidth(60);
				tablePesquisa.getColumnModel().getColumn(5).setPreferredWidth(60);
				tablePesquisa.getColumnModel().getColumn(5).setMaxWidth(65);
				tablePesquisa.getColumnModel().getColumn(10).setMinWidth(35);
				tablePesquisa.getColumnModel().getColumn(10).setPreferredWidth(40);
				tablePesquisa.getColumnModel().getColumn(10).setMaxWidth(45);
				tablePesquisa.getColumnModel().getColumn(11).setMinWidth(20);
				tablePesquisa.getColumnModel().getColumn(11).setPreferredWidth(20);
		...
		print.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					tablePesquisa.print(JTable.PrintMode.FIT_WIDTH, header, footer);
