...
public class HistoricoEntrada extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HistoricoEntrada frame = new HistoricoEntrada();
	...
	public HistoricoEntrada() throws ParseException {
		...
		JLabel lblTitulo = new JLabel("HIST\u00D3RICO DE ENTRADA");
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				tablePesquisa.setModel(historicoProdutoEntradaDao.tableHistoricoEntradaPesquisa(modelPesquisa, dataInicio, dataFim));
				tablePesquisa.getColumnModel().getColumn(0).setMinWidth(68);
				tablePesquisa.getColumnModel().getColumn(0).setPreferredWidth(70);
				tablePesquisa.getColumnModel().getColumn(0).setMaxWidth(72);
				tablePesquisa.getColumnModel().getColumn(2).setMinWidth(60);
				tablePesquisa.getColumnModel().getColumn(2).setPreferredWidth(60);
				tablePesquisa.getColumnModel().getColumn(2).setMaxWidth(60);
				tablePesquisa.getColumnModel().getColumn(3).setMinWidth(35);
				tablePesquisa.getColumnModel().getColumn(3).setPreferredWidth(40);
				tablePesquisa.getColumnModel().getColumn(3).setMaxWidth(45);
				tablePesquisa.getColumnModel().getColumn(9).setMinWidth(35);
				tablePesquisa.getColumnModel().getColumn(9).setPreferredWidth(40);
