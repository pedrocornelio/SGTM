...
public class NovasAplicacoesOficina extends JFrame {
	...
	public NovasAplicacoesOficina() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(NovasAplicacoesOficina.class.getResource("/image/user_interface/desktop_package.png")));
		...
		btnSearchPlaca.setIcon(new ImageIcon(NovasAplicacoesOficina.class.getResource("/image/user_interface/search.png")));
		...
		btnPlus.setIcon(new ImageIcon(NovasAplicacoesOficina.class.getResource("/image/user_interface/up.png")));
		...
		btnMinus.setIcon(new ImageIcon(NovasAplicacoesOficina.class.getResource("/image/user_interface/trash.png")));
		...
		btnAtualizarar.setIcon(new ImageIcon(NovasAplicacoesOficina.class.getResource("/image/user_interface/desktop_package.png")));
